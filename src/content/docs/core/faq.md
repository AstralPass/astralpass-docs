---
title: FAQ
description: Short answers to common questions about signing in, wallet linking, and roles.
---
...
Yes. AstralPass can evaluate rules across multiple linked wallets.

## Does linking a wallet give AstralPass control over my wallet?

No. Linking proves ownership. It does not give AstralPass control over your wallet.
...
Some DACs use wallet-linked data, Star Atlas state, or both to decide which roles should be assigned.
